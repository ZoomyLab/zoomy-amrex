...
Ported verbatim from the approved jax suite (proposals/2026-07-20-jax-test-suite-code.md).
The shape is user-ruled and NOT adaptable per backend: two functions, no
classes, no context managers, no fixture machinery beyond a single boolean.
Keeping it byte-identical across backends is the point -- a divergence here
would make jax and amrex results incomparable, which is the one thing the
